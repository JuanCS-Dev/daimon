"""
Standalone Biomimetic Safety Bridge Coverage Runner - Solves import timing issue

The problem: pytest imports consciousness modules during collection phase,
before coverage starts, causing modules to be "previously imported."
